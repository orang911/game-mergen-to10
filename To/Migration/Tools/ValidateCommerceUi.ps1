param([string]$RunName=('Run_'+(Get-Date -Format 'yyyyMMdd_HHmmss')),[string]$Method='MergeTo10.Editor.CommerceUiVerifier.Validate',[switch]$ScreenCapture=$true)
$ErrorActionPreference='Stop'
$unityProject='D:\UGit\T0\To'
...
$env:M2_EDITOR_OUTPUT=Join-Path $unityProject "Migration/Reports/Commerce/2026-09-14_v01/$RunName"
